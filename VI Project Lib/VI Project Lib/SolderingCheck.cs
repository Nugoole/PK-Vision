...
namespace VI_Project_Lib
{
    public partial class ImProcess
    {
        public void CircleDetect()
        {
            ...
            CircleSegment[] circles = Cv2.HoughCircles(imgData, HoughMethods.Gradient, 1, imgData.Rows / 50, 50, 40);
            ...
            foreach (var circle in circles)
            {
                ...
                Cv2.Circle(imgData, new Point((int)circle.Center.X, (int)circle.Center.Y), (int)circle.Radius, new Scalar(255,0,255), -1);
